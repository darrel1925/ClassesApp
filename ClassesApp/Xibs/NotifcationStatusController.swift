...
class NotifcationStatusController: UIViewController {
    ...
    func notifsOn() {
        ...
        self.descriptionLabel.text = "Click below to stop receiving class update notifications on this account. (Not Recommended)"
    }
    ...
    func notifsOff() {
        ...
        self.descriptionLabel.text = "Click below to begin receiving class update notifications on this account. (Recommended)"
    }
